...
overwrite <- TRUE
# Table 1
googledrive::drive_download("https://docs.google.com/spreadsheets/d/18bKV3mUuyIv1yPN7gps9HPmhROb4jz0x7KxtA8mf0iM/edit#gid=743954199", path = here::here("data/metaanalysis/TableS1.xlsx"), overwrite = overwrite)
# Table 2
googledrive::drive_download("https://docs.google.com/spreadsheets/d/19jz9l2P7W2f1PWT9t3x0L8h6VQL021RdRI7D4FAOjX0/edit#gid=314686952", path = here::here("data/metaanalysis/TableS2.xlsx"), overwrite = overwrite)

sheets <- readxl::excel_sheets(here::here("data/metaanalysis/TableS1.xlsx")) 

# if(overwrite) system(paste("chmod -R u=rwx,go=rwx",here::here()))
```
...
```{r}
data.table::fwrite(x = celltype_data[,c("Sheet","Cell_Type","Sig","Reference","Source","Dataset")], 
                   file = here::here("data/metaanalysis","merged_celltypes.csv") )
```
...
```{r}
data.table::fwrite(x = tissue_data[,c("Sheet","Tissue","Sig","Reference","Source","Dataset")], 
                   file= here::here("data/metaanalysis","merged_tissues.csv"))
```
